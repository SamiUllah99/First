					...
					<div class="panel-body">
						...
						<form method="POST" action="" >
							<div class="row">
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
										<label class="label label-success label-name" name="stdName" id="stdName">Faisal</label>
                                    </div>									
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
										<label class="label label-success label-name" name="class" id="class">8th</label>
                                    </div>    
                                </div>  
								<hr><br>
