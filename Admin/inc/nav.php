...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		<ul class="nav navbar-right top-nav">
			...
			<li>
				<a href="questionForum.php"><i class="fa fa-commenting-o" aria-hidden="true"></i> Discussion <span class="sr-only"></span></a>
			</li>
			<li>
				<a href="schedule.php"><i class="fa fa-calendar" aria-hidden="true"></i> Schedule <span class="sr-only"></span></a>
			</li>
			<li>
				<a href="events.php"><i class="fa fa-clock-o" aria-hidden="true"></i> Create Event <span class="sr-only"></span></a>
			</li>
		
			<li class="dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-envelope"><span class="badge bg-green">5</span></i> <b class="caret"></b></a>
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li>
						<a href="newAdmin.php"><i class="fa fa-fw fa-user"></i>  New Admin</a>
					</li>
					<li class="divider"></li>
					<li>
		...
		<ul class="nav navbar-nav side-nav">
			...
			<li>
				...
				<ul id="demo" class="collapse in">
					...
					<li>
						<a href="notes.php">- Upload Notes</a>
					</li>
					<li>
						<a href="notification.php">- Create Notification</a>
					</li>
					<li>
						<a href="marks.php">- Upload Marks</a>
					</li>
					<li>
						<a href="addClasses.php">- Add New Classes</a>
					</li>
					<li>
						<a href="studentProgress.php">- Student Progress</a>
					</li>
					<li>
			...
			<li>
				...
				<ul id="demo1" class="collapse">
					<li>
						<a href="../teacher/addTeacher.php">- Register Teacher</a>
					</li>
					<li>
						<a href="../teacher/updateTeacher.php">- Update Teacher</a>
					</li>
					<li>
						<a href="../teacher/teacherAttendance.php">- Attendance</a>
					</li>
					<li>
						<a href="../teacher/teacherSalary.php">- Teacher Salary</a>
					</li>
					<li>
						<a href="../teacher/teacherNotification.php">- Create Notification</a>
					</li>
					<li>
						<a href="../teacher/teacherRecord.php">- Teacher Record</a>
					</li>
					<li>
						<a href="../teacher/teacherSettings.php">- Teacher Settings</a>
					</li>
				</ul>
			</li>
			<li>
