						...
						<div class="main-reg">
							<form method="POST" action="" autocomplete="on">
								<div class="row">
									...
									<div class="col-lg-3 col-md-9 col-sm-9 col-xs-6">
								...
								<div class="row ">
									...
									<div class="col-lg-6 col-md-3 col-sm-3 col-xs-12">
										<input type="number" class="form-control" name="decrementSalary" id="decrementSalary" required min="0" placeholder="Enter Decrement in Salary"/>
