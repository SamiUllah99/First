		...
		<ul class="nav navbar-nav side-nav">
			...
			<li>
				...
				<ul id="demo2" class="collapse in">
					<li>
						<a href="addDriver.php">- Register Driver</a>
					</li>
					<li>
						<a href="updateDriver.php">- Update Driver</a>
					</li>
					 <li>
						<a href="busRoute.php">- Allocate Routes</a>
					</li>
					<li>
						<a href="driverSalary.php">- Driver Salary</a>
					</li>
					<li>
						<a href="deductionSalary.php">- Set Salary Deduction</a>
					</li>
					<li>
						<a href="driverRecord.php">- Driver Record</a>
					</li>
				</ul>
			</li>
			<li>
