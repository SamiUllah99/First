			...
			<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="text-center">Update Fees</h3>  
                    </div>
                    <div class=" panel-body">
                        <div class="main-reg">
                            <form method="POST" action="" autocomplete="on">
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
									<select name="stClass"  class="form-control" required value="<?php echo $stclass ?>"> <span class="error" ><?php echo $errstclass ?></span>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <input type="text" class="form-control" name="stdName" readonly id="stdName"/>
                                    </div>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <input type="text" class="form-control" name="totalAmount" id="totalAmount"  placeholder="Enter total amount" value="<?php echo $totalAmount ?>"/>
										<span class="error" ><?php echo $errtotalAmount ?></span>
                                    </div>
									<div class="col-lg-3"></div>
                                </div>
								&nbsp;	
								<div class="row ">
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <input type="text" class="form-control" name="paidAmount" id="paidAmount"  placeholder="Enter paid amount"value="<?php echo $paidAmount ?>"/>
										<span class="error" ><?php echo $errpaidAmount ?></span>
                                    </div>
									<div class="col-lg-3"></div>
                                </div>   	
								...
								<div class="row ">
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <input type="text" class="form-control" name="feeDues" id="feeDues"  placeholder="Enter fee dues" value="<?php echo $feeDues ?>"/>
										<span class="error" ><?php echo $errfeeDues ?></span>
                                    </div>
									<div class="col-lg-3"></div>
                                </div>
								&nbsp;
								<div class="row">
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                        ...
                                        <div class="input-group">
											...
											<input class="form-control" name="feedate" id="feedate" type="date" value="<?php echo $feedate ?>">
											<span class="error" ><?php echo $errfeeDate ?></span>
										</div>
                                    </div>
                                </div>   				
								&nbsp;
								...
								<div class="row ">
                                    <div class="col-lg-7 col-md-9 col-sm-9 col-xs-12">
										<div class="alert alert-success alert-dismissible" id="successAlert">
											...
											Fees has been updated Successfully!
										</div>
									</div>
									<div class="col-lg-5 col-md-3 col-sm-3 col-xs-12">
                                        <button type="submit" class="btn btn-success" name="btnUpdateFee" id="btnUpdateFee">Update Fees</button>
                                    </div>
									<div class="col-lg-3 "></div>
                                </div>   	
