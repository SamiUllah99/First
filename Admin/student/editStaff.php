...
if(isset($_POST["staffUpdate"])) {
			$staffUpdate= addslashes($_POST["staffUpdate"]);	
		if(empty($_POST["name"])) {
		...
		$obj_Staff->StaffID=$staffId;
		    if($obj_Staff->UpdateStaff($staffId)){
            	$msg="Update Complete";
            }
            else{
                $msg = "Update Failed";
					...
					<div class="row panel-body">
						<div class=" main-reg">
							<form class="form-horizontal" action="" method="post" onSubmit="return validations()">
								...
								<div class="row">
									<div class="col-lg-6 form-group ">
										<button type="submit" id="staffUpdate" name="staffUpdate" class="btn btn-primary btn-lg btn-block">Update</button>
									</div>
									<div class="col-lg-6" id="upadteDone">
                                    </div>
								</div>        
