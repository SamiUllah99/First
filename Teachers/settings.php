...
if(isset($_POST["teacherUpdate"])) {
			$teacherUpdate = addslashes($_POST["teacherUpdate"]);	
		if(empty($_POST["teacherName"])) {
			$errteacherName = "Please enter a Name";
		} else{
		  $teacherName = addslashes($_POST["teacherName"]);
		if (!preg_match("/^[a-zA-Z ]*$/",$teacherName)) {
		  $errteacherName = "Only letters and white space allowed"; 
			}
		}
					...
					<div class="panel-body">
						...
						<form method="POST" action="" >       
							...
							<div class="row">
								<div class="col-lg-6 form-group">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control" name="teacherName" id="teacherName"  placeholder="Ahmed Khan"value="<?php echo $teacherName?>"/>
							...
							<div class="row">
								<div class="col-lg-6 form-group ">
									&nbsp;
									<button type="submit" id="teacherUpdate" name="teacherUpdate" class="btn btn-primary pull-right">Update</button>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
